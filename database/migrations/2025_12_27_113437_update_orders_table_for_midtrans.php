...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Update enum (harus drop dulu, lalu create ulang)
        DB::statement("ALTER TABLE orders MODIFY COLUMN status ENUM('pending', 'processing', 'shipped', 'completed', 'cancelled') DEFAULT 'pending'");
        DB::statement("ALTER TABLE orders MODIFY COLUMN payment_status ENUM('unpaid', 'pending', 'paid', 'failed') DEFAULT 'unpaid'");
    }
